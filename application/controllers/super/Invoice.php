...
class Invoice extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->input->post()) {
			...
			if ($this->form_validation->run() == TRUE) {
				...
				$formarray = ['user' => $this->input->post('user'), 'date' => $this->input->post('date'),'bankaccount' => $this->input->post('bankaccount'), 'amount' => $this->input->post('amount'),'gst' => $this->input->post('gst'),'quantity' => $this->input->post('quantity'), 'invoicefor' => $this->input->post('invoicefor'), 'status' => $this->input->post('status')];
	...
	public function print($id, $uid)
	{
		...
		if ($id != NULL) {
			...
			$data['bankaccount'] = $this->Bankaccount_model->detailBankaccountByproviderinUserid($uid);
	...
	public function delete($id)
	{
		...
		public function bankaccountByproviderinServiceid()
	{
		$this->load->model('Bankaccount_model');
